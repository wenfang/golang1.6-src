...
const (
	MaxRune         = '\U0010FFFF' // Maximum valid Unicode code point. // 当前最大的unicode字符
	ReplacementChar = '\uFFFD'     // Represents invalid code points. // 代表无效的代码点
	MaxASCII        = '\u007F'     // maximum ASCII value. // 最大的ASCII值 C0控制符和基本的拉丁字符
	MaxLatin1       = '\u00FF'     // maximum Latin-1 value. // 最大的拉丁字符值 C1控制符和拉丁补充-1
)
...
func IsUpper(r rune) bool { // 判断rune字符是否是大写
...
func IsLower(r rune) bool { // 判断是否是大写
	// See comment in IsGraphic.
	if uint32(r) <= MaxLatin1 {
